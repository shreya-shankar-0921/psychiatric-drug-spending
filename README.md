...
DockerHub, run the following command from the project root:*

`docker build -t sshankar0921/final-project-report:latest .`

This will create a local image tagged
`sshankar0921/final-project-report:latest` that can be used in the
commands below.
