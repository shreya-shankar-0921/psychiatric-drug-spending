...
if (!file.exists(file.path("outputs", "00_clean_data.rds"))) {
  source("code/00_clean_data.R")
}

clean_data <- readRDS(file.path("outputs", "00_clean_data.rds"))
...
if (!file.exists(file.path("outputs", "table1.rds"))) {
  source("code/01_make_table1.R")
}
...
if (!file.exists(file.path("outputs", "figure1.rds"))) {
  source("code/02_make_figure.R")  # adjust path/name
}
